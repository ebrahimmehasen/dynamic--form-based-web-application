...
{
    /// <inheritdoc />
    public partial class AddAzharCertificateSupport : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AzharStudentTotals",
                schema: "dbo",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AzharStudentTotals", x => x.StudentId);
                    table.ForeignKey(
                        name: "FK_AzharStudentTotals_Students_StudentId",
